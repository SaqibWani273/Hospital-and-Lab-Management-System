              ...
              <div class="row">
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    ...
                    <a href="Addetails.php">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span></a>
                ...
                <div class="col-sm-4" id="col2">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="cl-effect-1">
                        <a href="Aadddoc.php" >Add Doctors</a>
                        &nbsp;|
                        <a href="Addoc.php" >
                          Delete Doctors
                        </a>
