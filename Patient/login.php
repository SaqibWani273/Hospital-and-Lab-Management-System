...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="loginstyle.css?v=<?php echo time()?>">
         ...
         <div class="col-md-4 card1">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="loginAction.php">
                ...
                <div class="row">
                 <div class="col-md-4" id='loginbtn'>
                    <center><input type="submit" id="inputbtn" name="loginsub" value="Login" class="btn btn-primary"></center></div>           
