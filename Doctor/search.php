...
<title>Search pateint </title>
  ...
  if(isset($_POST['submitsearch'])){
    ...
    $sql="select * from appointmenttable where contact='$contact' and doctor='$username'";
...
<div><a href="doctorpanel.php" class="btn btn-light">Go Back</a></div>
<!-- Optional JavaScript -->
