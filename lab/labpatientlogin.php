...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../patient/loginstyle.css?v=<?php echo time()?>">
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                ...
                <br>
              <h3 style="margin-top: 10%">Lab Patient Login</h3><br>
              <form class="form-group" method="POST" action="Action.php">
                ...
                <div class="row">
                 <div class="col-md-4" id='loginbtn'>
                    <center><input type="submit" id="inputbtn" name="labloginsub" value="Login" class="btn btn-primary"></center></div>           
