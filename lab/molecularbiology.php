...
<?php  include('labheader.php');?>
   ...
   <div class="container">
<h1>Department-> <span><i><small>Molecularbiology</small> <i></span></h1>
 <div class="container-fluid">
 <h2>Molecularbiology</h2>
 <p class="text-justify">

 As a leader in healthcare, Apollo Diagnostics simplifies the way to better health through patient-definite diagnostic data.</p>
