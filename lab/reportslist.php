...
<td><?php 
if($row['reportstatus']==0){?> <a href="addreport.php?patient=<?php echo $row['patientname'] ?>&id=<?php echo $row['id']?>&pstatus=0&username=<?php echo $row['username'];?>" class='btn btn-success'>Add Report</a>
<?php
}
else{
echo $row['ReportDetails'];?><a href="addreport.php?patient=<?php echo $row['patientname'] ?>&id=<?php echo $row['id']?>&pstatus=1&username=<?php echo $row['username'];?>"  class='btn btn-primary'>Edit Report</a>
<?php
}
?>
</td>
